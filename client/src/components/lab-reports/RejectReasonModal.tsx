...
export default function RejectReasonModal({ isOpen, onClose, onSubmit }: RejectReasonModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-end z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto mt-16 mr-4">
        {/* Modal Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            <Textarea
              ...
              className="w-full h-32 resize-none border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 rounded-lg text-sm placeholder:text-gray-400"
              required
            />
          </div>
